...
function Footer() {
    return <footer className={cx('wrapper')}>
        <div className={cx('footer-information')}>
            <a className={cx('logo')} href='/'>Inlr.</a>
            <div className={cx('container')}>
                <div className={cx('footer-list')}>
                    ...
                    <p className={cx('description')}>
                        ...
                        Tempora minima ducimus laudantium saepe sapiente! Omnis consequuntur incidunt 
                        amet sequi qui, accusamus aliquam eos rerum doloremque cupiditate dolore dolores.
                    </p>
                </div>

                <div className={cx('footer-list')}>
                    <p className={cx('title')}>Products</p>
                ...
                <div className={cx('footer-list')}>
                    ...
                    <div className={cx('list-social', 'list-item')}>
                        <div className={cx('social-icon')}>
                            <a href="/"> 
                                <span className={cx('icons', 'icon-facebook')}> <FontAwesomeIcon icon={faFacebookF} className={cx('icon-item')} /> </span> 
                                Like us on Facebook
                            </a>
                        </div>
                        ...
                        <div className={cx('social-icon')}>
                            <a href="/"> 
                                <span className={cx('icons', 'icon-twitter')}> <FontAwesomeIcon icon={faTwitter} className={cx('icon-item')} /> </span> 
                        ...
                        <div className={cx('social-icon')}>
                            <a href="/"> 
                                <span className={cx('icons', 'icon-google-plus')}> <FontAwesomeIcon icon={faGooglePlusG} className={cx('icon-item')} /> </span> 
                        ...
                        <div className={cx('social-icon')}>
                            <a href="/"> 
                                <span className={cx('icons', 'icon-dribbble')}> <FontAwesomeIcon icon={faDribbble} className={cx('icon-item')} /> </span> 
                        ...
                        <div className={cx('social-icon')}>
                            <a href="/"> 
                                <span className={cx('icons', 'icon-piterest')}> <FontAwesomeIcon icon={faPinterestP} className={cx('icon-item')} /> </span> 
                    ...
                    <div className={cx('list-item')}>
                        ...
                        <div className={cx('social-icon')}>
                            <a href="tel:+(480)555-0103">
                                <span className={cx('icons')}>
                                    <FontAwesomeIcon icon={faMobileAlt} className={cx('icon-ig', 'icon-item')} />
                                </span>
                                (480) 555-0103
                            </a>
                        </div>
                ...
                <div className={cx('footer-list')}>
                    ...
                    <form className={cx('form-news-letter')}>
                        <div className={cx('form-group')}>
                            ...
                            <input type="email" className={cx('email-news-letter')} placeholder="Enter email here"/>
